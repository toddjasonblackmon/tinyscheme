...
//        snprintf(q, len_str+1, "%s", str);
          strncpy (q, str, len_str+1);
          q[len_str] = '\0';  // make sure we're terminated.
     } else {
...
//        snprintf(tmp, STRBUFFSIZE, "0%s", name+1);
          tmp[0] = '0';
          strncpy (tmp+1, name+1, STRBUFFSIZE-1);
          tmp[STRBUFFSIZE-1] = '\0';  //strncpy can possibly not be null terminated.
...
//        snprintf(tmp, STRBUFFSIZE, "0x%s", name+1);
          tmp[0] = '0';
          tmp[1] = 'x';
          strncpy (tmp+2, name+1, STRBUFFSIZE-2);
          tmp[STRBUFFSIZE-1] = '\0';  //strncpy can possibly not be null terminated.
